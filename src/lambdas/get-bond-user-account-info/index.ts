...
exports.getBondUserAccountInfo = async (event: any) => {
  let response;
  try {
    ...
    const getUserAccountInfo = container.get(Types.GetUserAccountInfo);

    const data = await getUserAccountInfo.execute({
